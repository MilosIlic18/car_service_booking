@extends('layouts.layout_admin')
    ...
    <h1 class="mb-[15px] mx-[5px] text-xl text-bold">Servisni tipovi</h1>
    ...
    <div class="md:flex gap-5 w-full">
        <div class="mb:mb-[0px] mb-[10px]">
            <form class="max-w-sm mx-auto bg-white rounded-lg p-[20px] mt-10 w-[350px]" method="POST" action="{{route('admin.service-types.store')}}">
                {{ csrf_field() }}
                <h1 class="text-xl text-center mb-[10px]">Forma za unos tipa servisa</h1>
                <div class="mb-5">
                ...
                <button type="submit" class="mb-[5px] text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Unesi tip servisa</button>        
            </form>
        </div>
